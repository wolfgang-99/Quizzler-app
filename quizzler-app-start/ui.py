...
class Quizinterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_lable = Label(text=f"score:", fg="white", bg=THEME_COLOR)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.canvas_text, text="you have the end of the quiz")
